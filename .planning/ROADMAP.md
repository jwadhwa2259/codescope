...
- v2.1 Eval Fixes & Real-World Quality -- Phases 17-20 (shipped 2026-03-31) -- [Archive](milestones/v2.1-ROADMAP.md)
...
<details>
<summary>v2.1 Eval Fixes & Real-World Quality (Phases 17-20) -- SHIPPED 2026-03-31</summary>

- [x] **Phase 17: Foundation Fixes** (5/5 plans) -- complete 2026-03-30
- [x] **Phase 18: Semantic Conventions** (4/4 plans) -- complete 2026-03-31
- [x] **Phase 19: Intelligence Features** (3/3 plans) -- complete 2026-03-31
- [x] **Phase 20: Eval DB Fix + Audit Cleanup** (2/2 plans) -- complete 2026-03-31
...
| 18. Semantic Conventions | v2.1 | 4/4 | Complete | 2026-03-31 |
